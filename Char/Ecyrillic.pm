...
#
package Char::Ecyrillic;
######################################################################
#
# Char::Ecyrillic - Run-time routines for Char/Cyrillic.pm
#
...
BEGIN {
    ...
    sub qualify ($;$) {
        my ($name) = @_;
        if (!ref($name) && (Char::Ecyrillic::index($name, '::') == -1) && (Char::Ecyrillic::index($name, "'") == -1)) {
            my $pkg;
...
#
# Cyrillic character range per length
#
my %range_tr = ();
...
sub import {
    ...
    if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
        ...
        for (@ARGV) {
            ...
            # has space
            if (/\A (?:$q_char)*? [ ] /oxms) {
                if (my @glob = Char::Ecyrillic::glob(qq{"$_"})) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
            ...
            # has wildcard metachar
                ...
                if (my @glob = Char::Ecyrillic::glob($_)) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
...
#
sub unimport {}
sub Char::Ecyrillic::split(;$$$);
sub Char::Ecyrillic::tr($$$$;$);
sub Char::Ecyrillic::chop(@);
sub Char::Ecyrillic::index($$;$);
sub Char::Ecyrillic::rindex($$;$);
sub Char::Ecyrillic::lcfirst(@);
sub Char::Ecyrillic::lcfirst_();
sub Char::Ecyrillic::lc(@);
sub Char::Ecyrillic::lc_();
sub Char::Ecyrillic::ucfirst(@);
sub Char::Ecyrillic::ucfirst_();
sub Char::Ecyrillic::uc(@);
sub Char::Ecyrillic::uc_();
sub Char::Ecyrillic::fc(@);
sub Char::Ecyrillic::fc_();
sub Char::Ecyrillic::ignorecase;
sub Char::Ecyrillic::classic_character_class;
sub Char::Ecyrillic::capture;
sub Char::Ecyrillic::chr(;$);
sub Char::Ecyrillic::chr_();
sub Char::Ecyrillic::glob($);
sub Char::Ecyrillic::glob_();

sub Char::Cyrillic::ord(;$);
sub Char::Cyrillic::ord_();
sub Char::Cyrillic::reverse(@);
sub Char::Cyrillic::getc(;*@);
sub Char::Cyrillic::length(;$);
sub Char::Cyrillic::substr($$;$$);
sub Char::Cyrillic::index($$;$);
sub Char::Cyrillic::rindex($$;$);
sub Char::Cyrillic::escape(;$);
...
${Char::Ecyrillic::dot}         = qr{(?:[^\x0A])};
${Char::Ecyrillic::dot_s}       = qr{(?:[\x00-\xFF])};
${Char::Ecyrillic::eD}          = qr{(?:[^0-9])};
...
# ${Char::Ecyrillic::eS}        = qr{(?:[^\x09\x0A    \x0C\x0D\x20])};
# ${Char::Ecyrillic::eS}        = qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])};
${Char::Ecyrillic::eS}          = qr{(?:[^\s])};

${Char::Ecyrillic::eW}          = qr{(?:[^0-9A-Z_a-z])};
${Char::Ecyrillic::eH}          = qr{(?:[^\x09\x20])};
${Char::Ecyrillic::eV}          = qr{(?:[^\x0A\x0B\x0C\x0D])};
${Char::Ecyrillic::eR}          = qr{(?:\x0D\x0A|[\x0A\x0D])};
${Char::Ecyrillic::eN}          = qr{(?:[^\x0A])};
${Char::Ecyrillic::not_alnum}   = qr{(?:[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Char::Ecyrillic::not_alpha}   = qr{(?:[^\x41-\x5A\x61-\x7A])};
${Char::Ecyrillic::not_ascii}   = qr{(?:[^\x00-\x7F])};
${Char::Ecyrillic::not_blank}   = qr{(?:[^\x09\x20])};
${Char::Ecyrillic::not_cntrl}   = qr{(?:[^\x00-\x1F\x7F])};
${Char::Ecyrillic::not_digit}   = qr{(?:[^\x30-\x39])};
${Char::Ecyrillic::not_graph}   = qr{(?:[^\x21-\x7F])};
${Char::Ecyrillic::not_lower}   = qr{(?:[^\x61-\x7A])};
${Char::Ecyrillic::not_lower_i} = qr{(?:[\x00-\xFF])};
${Char::Ecyrillic::not_print}   = qr{(?:[^\x20-\x7F])};
${Char::Ecyrillic::not_punct}   = qr{(?:[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Char::Ecyrillic::not_space}   = qr{(?:[^\s\x0B])};
${Char::Ecyrillic::not_upper}   = qr{(?:[^\x41-\x5A])};
${Char::Ecyrillic::not_upper_i} = qr{(?:[\x00-\xFF])};
${Char::Ecyrillic::not_word}    = qr{(?:[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Char::Ecyrillic::not_xdigit}  = qr{(?:[^\x30-\x39\x41-\x46\x61-\x66])};
${Char::Ecyrillic::eb}          = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Char::Ecyrillic::eB}          = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Char::Ecyrillic::foo" used only once: possible typo at here.
${Char::Ecyrillic::dot}         = ${Char::Ecyrillic::dot};
${Char::Ecyrillic::dot_s}       = ${Char::Ecyrillic::dot_s};
${Char::Ecyrillic::eD}          = ${Char::Ecyrillic::eD};
${Char::Ecyrillic::eS}          = ${Char::Ecyrillic::eS};
${Char::Ecyrillic::eW}          = ${Char::Ecyrillic::eW};
${Char::Ecyrillic::eH}          = ${Char::Ecyrillic::eH};
${Char::Ecyrillic::eV}          = ${Char::Ecyrillic::eV};
${Char::Ecyrillic::eR}          = ${Char::Ecyrillic::eR};
${Char::Ecyrillic::eN}          = ${Char::Ecyrillic::eN};
${Char::Ecyrillic::not_alnum}   = ${Char::Ecyrillic::not_alnum};
${Char::Ecyrillic::not_alpha}   = ${Char::Ecyrillic::not_alpha};
${Char::Ecyrillic::not_ascii}   = ${Char::Ecyrillic::not_ascii};
${Char::Ecyrillic::not_blank}   = ${Char::Ecyrillic::not_blank};
${Char::Ecyrillic::not_cntrl}   = ${Char::Ecyrillic::not_cntrl};
${Char::Ecyrillic::not_digit}   = ${Char::Ecyrillic::not_digit};
${Char::Ecyrillic::not_graph}   = ${Char::Ecyrillic::not_graph};
${Char::Ecyrillic::not_lower}   = ${Char::Ecyrillic::not_lower};
${Char::Ecyrillic::not_lower_i} = ${Char::Ecyrillic::not_lower_i};
${Char::Ecyrillic::not_print}   = ${Char::Ecyrillic::not_print};
${Char::Ecyrillic::not_punct}   = ${Char::Ecyrillic::not_punct};
${Char::Ecyrillic::not_space}   = ${Char::Ecyrillic::not_space};
${Char::Ecyrillic::not_upper}   = ${Char::Ecyrillic::not_upper};
${Char::Ecyrillic::not_upper_i} = ${Char::Ecyrillic::not_upper_i};
${Char::Ecyrillic::not_word}    = ${Char::Ecyrillic::not_word};
${Char::Ecyrillic::not_xdigit}  = ${Char::Ecyrillic::not_xdigit};
${Char::Ecyrillic::eb}          = ${Char::Ecyrillic::eb};
${Char::Ecyrillic::eB}          = ${Char::Ecyrillic::eB};
...
#
# Cyrillic lower case first with parameter
#
sub Char::Ecyrillic::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Ecyrillic::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Ecyrillic::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Ecyrillic::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Cyrillic lower case first without parameter
#
sub Char::Ecyrillic::lcfirst_() {
    return Char::Ecyrillic::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Cyrillic lower case with parameter
#
sub Char::Ecyrillic::lc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Char::Ecyrillic::lc_();
    }
}

#
# Cyrillic lower case without parameter
#
sub Char::Ecyrillic::lc_() {
    my $s = $_;
    return join '', map {defined($lc{$_}) ? $lc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Cyrillic upper case first with parameter
#
sub Char::Ecyrillic::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Ecyrillic::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Ecyrillic::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Ecyrillic::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}

#
# Cyrillic upper case first without parameter
#
sub Char::Ecyrillic::ucfirst_() {
    return Char::Ecyrillic::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
}
...
#
# Cyrillic upper case with parameter
#
sub Char::Ecyrillic::uc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Char::Ecyrillic::uc_();
    }
}

#
# Cyrillic upper case without parameter
#
sub Char::Ecyrillic::uc_() {
    my $s = $_;
    return join '', map {defined($uc{$_}) ? $uc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Cyrillic fold case with parameter
#
sub Char::Ecyrillic::fc(@) {
    if (@_) {
        my $s = shift @_;
        ...
        return Char::Ecyrillic::fc_();
    }
}

#
# Cyrillic fold case without parameter
#
sub Char::Ecyrillic::fc_() {
    my $s = $_;
    return join '', map {defined($fc{$_}) ? $fc{$_} : $_} ($s =~ /\G ($q_char) /oxmsg);
...
#
# Cyrillic regexp ignore case modifier
#
sub Char::Ecyrillic::ignorecase {
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Char::Ecyrillic::uc($char[$i]);
                my $fc = Char::Ecyrillic::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
...
#
# prepare Cyrillic characters per length
#
...
#
# Cyrillic open character list for tr
#
sub _charlist_tr {
...
#
# Cyrillic open character list for qr and not qr
#
sub _charlist {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Char::Ecyrillic::not_lower_i}',
                '[:^upper:]'  => '${Char::Ecyrillic::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Char::Ecyrillic::not_alnum}',
                '[:^alpha:]'  => '${Char::Ecyrillic::not_alpha}',
                '[:^ascii:]'  => '${Char::Ecyrillic::not_ascii}',
                '[:^blank:]'  => '${Char::Ecyrillic::not_blank}',
                '[:^cntrl:]'  => '${Char::Ecyrillic::not_cntrl}',
                '[:^digit:]'  => '${Char::Ecyrillic::not_digit}',
                '[:^graph:]'  => '${Char::Ecyrillic::not_graph}',
                '[:^lower:]'  => '${Char::Ecyrillic::not_lower}',
                '[:^print:]'  => '${Char::Ecyrillic::not_print}',
                '[:^punct:]'  => '${Char::Ecyrillic::not_punct}',
                '[:^space:]'  => '${Char::Ecyrillic::not_space}',
                '[:^upper:]'  => '${Char::Ecyrillic::not_upper}',
                '[:^word:]'   => '${Char::Ecyrillic::not_word}',
                '[:^xdigit:]' => '${Char::Ecyrillic::not_xdigit}',
...
#
# Cyrillic octal escape sequence
#
sub octchr {
    my($octdigit) = @_;
...
#
# Cyrillic hexadecimal escape sequence
#
sub hexchr {
    my($hexdigit) = @_;
...
#
# Cyrillic open character list for qr
#
sub charlist_qr {
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Ecyrillic::uc($char);
                        my $fc = Char::Ecyrillic::fc($char);
                        if ($uc eq $fc) {
...
#
# Cyrillic open character list for not qr
#
sub charlist_not_qr {
...
#
# Cyrillic order to character (with parameter)
#
sub Char::Ecyrillic::chr(;$) {
...
#
# Cyrillic order to character (without parameter)
#
sub Char::Ecyrillic::chr_() {
...
#
# Cyrillic path globbing (with parameter)
#
sub Char::Ecyrillic::glob($) {
...
#
# Cyrillic path globbing (without parameter)
#
sub Char::Ecyrillic::glob_() {
...
#
# Cyrillic path globbing via File::DosGlob 1.10
#
...
#
# Cyrillic path globbing subroutine
#
sub _do_glob {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Ecyrillic::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Ecyrillic::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Char::Ecyrillic::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Char::Ecyrillic::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
#
sub Char::Ecyrillic::POSTMATCH {
    return $';
}

#
# Cyrillic character to order (with parameter)
#
sub Char::Cyrillic::ord(;$) {
...
#
# Cyrillic character to order (without parameter)
#
sub Char::Cyrillic::ord_() {
...
#
# Cyrillic getc (with parameter, without parameter)
#
sub Char::Cyrillic::getc(;*@) {

    my($package) = caller;
    my $fh = @_ ? qualify_to_ref(shift,$package) : \*STDIN;
    croak 'Too many arguments for Char::Cyrillic::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Char::Ecyrillic::dot_s} \z/oxms) {
...
#
# Cyrillic index by character
#
sub Char::Cyrillic::index($$;$) {

    my $index;
    if (@_ == 3) {
        $index = Char::Ecyrillic::index($_[0], $_[1], CORE::length(Char::Cyrillic::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Char::Ecyrillic::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Char::Cyrillic::length(CORE::substr $_[0], 0, $index);
    }
}

#
# Cyrillic rindex by character
#
sub Char::Cyrillic::rindex($$;$) {

    my $rindex;
    if (@_ == 3) {
        $rindex = Char::Ecyrillic::rindex($_[0], $_[1], CORE::length(Char::Cyrillic::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Char::Ecyrillic::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Char::Cyrillic::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $qq_substr  = qr{(?: Char::Cyrillic::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
sub Char::Cyrillic::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::Cyrillic::escape_token();
    }
...
#
# escape Cyrillic token of script
#
sub Char::Cyrillic::escape_token {
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Ecyrillic::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ \s* PREMATCH  \b | \$ \s* \{ \s* PREMATCH  \s* \} | \$ \s* \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ecyrillic::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Ecyrillic::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ecyrillic::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Ecyrillic::POSTMATCH()
    elsif (/\G (                 \$ \s* POSTMATCH \b | \$ \s* \{ \s* POSTMATCH \s* \} | \$ \s* \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Ecyrillic::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Char::Ecyrillic::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while \s* \( \s* glob \s* \) /oxgc) {
        return 'while ($_ = Char::Ecyrillic::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while \s* \( \s* glob \b /oxgc) {
        return 'while ($_ = Char::Ecyrillic::glob';
    }
...
# subroutines of package Char::Ecyrillic
    elsif (/\G \b (CORE:: | ->[ ]* (?: atan2 | [a-z]{2,})) \b  /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::Cyrillic::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::Cyrillic::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::Cyrillic::escape'; }
    elsif (/\G \b bytes::substr \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::chop';       }
    elsif (/\G \b bytes::index \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::Cyrillic::index \b   (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Cyrillic::index';       }
    elsif (/\G \b index \b         (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::index';      }
    elsif (/\G \b bytes::rindex \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::Cyrillic::rindex \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Cyrillic::rindex';      }
    elsif (/\G \b rindex \b        (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::rindex';     }
    elsif (/\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::lc';         }
    elsif (/\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::lcfirst';    }
    elsif (/\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::uc';         }
    elsif (/\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::ucfirst';    }
    elsif (/\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::fc';         }
    ...
    elsif (/\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::chr';               }
    elsif (/\G \b bytes::ord    (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::glob';              }
    elsif (/\G \b lc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::lc_';               }
    elsif (/\G \b lcfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::lcfirst_';          }
    elsif (/\G \b uc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::uc_';               }
    elsif (/\G \b ucfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::ucfirst_';          }
    elsif (/\G \b fc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! \s* => )                      /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! \s* => )                      /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Ecyrillic::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Ecyrillic::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Char::Ecyrillic::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq       (\#) [ ] (\#) /oxgc) { return 'Char::Ecyrillic::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Ecyrillic::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Ecyrillic::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Ecyrillic::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Ecyrillic::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Ecyrillic::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q        (\#) [ ] (\#) /oxgc) { return 'Char::Ecyrillic::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Ecyrillic::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Ecyrillic::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Ecyrillic::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Ecyrillic::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Ecyrillic::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                ' [ ] '    /oxgc) { return 'Char::Ecyrillic::split' . $e . qq     {' '};  }
        elsif (/\G                " [ ] "    /oxgc) { return 'Char::Ecyrillic::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Char::Ecyrillic::PREMATCH()]}
            ...
            $e_string .= q{Char::Ecyrillic::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Char::Ecyrillic::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Char::Ecyrillic::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Char::Ecyrillic::POSTMATCH()]}
            ...
            $e_string .= q{Char::Ecyrillic::POSTMATCH()};
            $slash = 'div';
        }
...
# subroutines of package Char::Ecyrillic
        ...
        elsif ($string =~ /\G \b Char::Cyrillic::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Cyrillic::eval \b                                /oxgc) { $e_string .= 'eval Char::Cyrillic::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                             /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                      /oxgc) { $e_string .= 'Char::Ecyrillic::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                              /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Cyrillic::index \b                               /oxgc) { $e_string .= 'Char::Cyrillic::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                     /oxgc) { $e_string .= 'Char::Ecyrillic::index';      $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::rindex \b                             /oxgc) { $e_string .= 'rindex';            $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Cyrillic::rindex \b                              /oxgc) { $e_string .= 'Char::Cyrillic::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                    /oxgc) { $e_string .= 'Char::Ecyrillic::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ecyrillic::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ecyrillic::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ecyrillic::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ecyrillic::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ecyrillic::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ecyrillic::chr';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Ecyrillic::glob';              $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                              /oxgc) { $e_string .= 'Char::Ecyrillic::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                         /oxgc) { $e_string .= 'Char::Ecyrillic::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                              /oxgc) { $e_string .= 'Char::Ecyrillic::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                         /oxgc) { $e_string .= 'Char::Ecyrillic::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                              /oxgc) { $e_string .= 'Char::Ecyrillic::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                             /oxgc) { $e_string .= 'Char::Ecyrillic::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                      /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                             /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                            /oxgc) { $e_string .= 'Char::Ecyrillic::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Ecyrillic::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq       (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q        (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                ' [ ] '    /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                " [ ] "    /oxgc) { $e_string .= 'Char::Ecyrillic::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
# <WILDCARD>   --- glob
            ...
            $e_string .= 'Char::Ecyrillic::glob("' . $1 . '")';
        }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Char::Ecyrillic::dot_s}';
        }
        else {
            return '${Char::Ecyrillic::dot}';
        }
    }
    else {
        return Char::Ecyrillic::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Char::Ecyrillic::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Char::Ecyrillic::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Char::Ecyrillic::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Char::Ecyrillic::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Char::Ecyrillic::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Char::Ecyrillic::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Char::Ecyrillic::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Char::Ecyrillic::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Char::Ecyrillic::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Ecyrillic::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Ecyrillic::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Ecyrillic::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Ecyrillic::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Char::Ecyrillic::uc($char[$i]) ne Char::Ecyrillic::fc($char[$i]))) {
            if (CORE::length(Char::Ecyrillic::fc($char[$i])) == 1) {
                $char[$i] = '['   . Char::Ecyrillic::uc($char[$i])       . Char::Ecyrillic::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Char::Ecyrillic::uc($char[$i]) . '|' . Char::Ecyrillic::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ecyrillic::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ \s* 0 \s* \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Ecyrillic::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ecyrillic::ignorecase(Char::Ecyrillic::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ecyrillic::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Ecyrillic::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ecyrillic::ignorecase(Char::Ecyrillic::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ecyrillic::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Ecyrillic::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ecyrillic::ignorecase(Char::Ecyrillic::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Ecyrillic::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::Cyrillic::re_t=%s; while($Char::Cyrillic::re_t =~ %s){%s local $^W=0; local $Char::Cyrillic::re_r=%s; %s$Char::Cyrillic::re_t="$`$Char::Cyrillic::re_r$'"; pos($Char::Cyrillic::re_t)=length "$`$Char::Cyrillic::re_r"; } return $Char::Cyrillic::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::Cyrillic::re_r=CORE::eval $Char::Cyrillic::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::Cyrillic::re_r=%s; %s"%s$Char::Cyrillic::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::Cyrillic::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::Cyrillic::re_r=%s; %s%s="$`$Char::Cyrillic::re_r$'"; pos(%s)=length "$`$Char::Cyrillic::re_r"; $Char::Cyrillic::re_n++} return %s$Char::Cyrillic::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::Cyrillic::re_r=%s; %s%s="%s$Char::Cyrillic::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::Cyrillic::re_r=%s; %s%s="%s$Char::Cyrillic::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::Cyrillic::re_r=CORE::eval $Char::Cyrillic::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # ${ foo }
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Ecyrillic::ignorecase(' . $1 . ')]}';
            }
        }
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Char::Ecyrillic::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Char::Ecyrillic::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  use Char::Ecyrillic;
    ...
    Char::Ecyrillic::split(...);
    Char::Ecyrillic::tr(...);
    Char::Ecyrillic::chop(...);
    Char::Ecyrillic::index(...);
    Char::Ecyrillic::rindex(...);
    Char::Ecyrillic::lc(...);
    Char::Ecyrillic::lc_;
    Char::Ecyrillic::lcfirst(...);
    Char::Ecyrillic::lcfirst_;
    Char::Ecyrillic::uc(...);
    Char::Ecyrillic::uc_;
    Char::Ecyrillic::ucfirst(...);
    Char::Ecyrillic::ucfirst_;
    Char::Ecyrillic::fc(...);
    Char::Ecyrillic::fc_;
    Char::Ecyrillic::ignorecase(...);
    Char::Ecyrillic::capture(...);
    Char::Ecyrillic::chr(...);
    Char::Ecyrillic::chr_;
    Char::Ecyrillic::glob(...);
    Char::Ecyrillic::glob_;

  # "no Char::Ecyrillic;" not supported

=head1 ABSTRACT

This module has run-time routines for use Char::Cyrillic software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Char::Cyrillic software and not
...
This Char::Ecyrillic module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  @split = Char::Ecyrillic::split(/pattern/,$string,$limit);
  @split = Char::Ecyrillic::split(/pattern/,$string);
  @split = Char::Ecyrillic::split(/pattern/);
  @split = Char::Ecyrillic::split('',$string,$limit);
  @split = Char::Ecyrillic::split('',$string);
  @split = Char::Ecyrillic::split('');
  @split = Char::Ecyrillic::split();
  @split = Char::Ecyrillic::split;
  ...
  at all, Char::Ecyrillic::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Ecyrillic::split(//,  $word);
  @fields = Char::Ecyrillic::split(/:/, $line);
  @words  = Char::Ecyrillic::split(" ", $paragraph);
  @lines  = Char::Ecyrillic::split(/^/, $buffer);
  ...
  print join(":" => Char::Ecyrillic::split(/ */, "hi there"));
  ...
  Char::Ecyrillic::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Ecyrillic::split(/:/, $_, 3);
  ...
  splits on whitespace just as Char::Ecyrillic::split with no arguments does. Thus,
  Char::Ecyrillic::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Ecyrillic::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Ecyrillic::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Ecyrillic::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Ecyrillic::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Ecyrillic::split is join, except that join can only join with the
...
=item Transliteration
  ...
  $tr = Char::Ecyrillic::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Char::Ecyrillic::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  This subroutine scans a Cyrillic string character by character and replaces all
  occurrences of the characters found in $searchlist with the corresponding character
  in $replacementlist. It returns the number of characters replaced or deleted.
  If no Cyrillic string is specified via =~ operator, the $_ variable is translated.
  $modifier are:
  ...
  print Char::Ecyrillic::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item Chop string

  $chop = Char::Ecyrillic::chop(@list);
  $chop = Char::Ecyrillic::chop();
  $chop = Char::Ecyrillic::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Char::Ecyrillic::chop subroutine is used primary to remove the newline
  ...
  since Char::Ecyrillic::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Ecyrillic::chop a literal, only a variable. If you Char::Ecyrillic::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Ecyrillic::chop(@lines);

  You can Char::Ecyrillic::chop anything that is an lvalue, including an assignment:

  Char::Ecyrillic::chop($cwd = `pwd`);
  Char::Ecyrillic::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Ecyrillic::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Ecyrillic::chop returns the character
  ...
  In the most general case, Char::Ecyrillic::chop can be expressed using substr:

  $last_code = Char::Ecyrillic::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Ecyrillic::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Ecyrillic::chop;
...
=item Index string
  ...
  $byte_pos = Char::Ecyrillic::index($string,$substr,$byte_offset);
  $byte_pos = Char::Ecyrillic::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Ecyrillic::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Ecyrillic::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Ecyrillic::rindex($string,$substr);

  This subroutine works just like Char::Ecyrillic::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Ecyrillic::index).
  ...
  while (($byte_pos = Char::Cyrillic::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  $lc = Char::Ecyrillic::lc($string);
  $lc = Char::Ecyrillic::lc_;

  This subroutine returns a lowercased version of Cyrillic $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \L escape
  in double-quoted strings.

  You can use the Char::Ecyrillic::fc subroutine for case-insensitive comparisons via Char::Cyrillic
  software.

=item Lower case first character of string

  $lcfirst = Char::Ecyrillic::lcfirst($string);
  $lcfirst = Char::Ecyrillic::lcfirst_;

  This subroutine returns a version of Cyrillic $string with the first character
  lowercased (or $_, if $string is omitted). This is the internal subroutine
  implementing the \l escape in double-quoted strings.

=item Upper case string

  $uc = Char::Ecyrillic::uc($string);
  $uc = Char::Ecyrillic::uc_;

  This subroutine returns an uppercased version of Cyrillic $string (or $_, if
  $string is omitted). This is the internal subroutine implementing the \U escape
  in interpolated strings. For titlecase, use Char::Ecyrillic::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Char::Ecyrillic::ucfirst($string);
  $ucfirst = Char::Ecyrillic::ucfirst_;
  ...
  $titlecase = Char::Ecyrillic::ucfirst(substr($word,0,1)) . Char::Ecyrillic::lc(substr($word,1));
  ...
  $do_not_use = Char::Ecyrillic::ucfirst(Char::Ecyrillic::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Ecyrillic::fc($string);
  $fc = Char::Ecyrillic::fc_;

  New to Char::Cyrillic software, this subroutine returns the full Unicode-like casefold of
  Cyrillic $string (or $_, if omitted). This is the internal subroutine implementing
  ...
  Char::Ecyrillic::fc($a) eq Char::Ecyrillic::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::Cyrillic software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Char::Ecyrillic::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item Make capture number

  $capturenumber = Char::Ecyrillic::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item Make character

  $chr = Char::Ecyrillic::chr($code);
  $chr = Char::Ecyrillic::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Char::Ecyrillic::chr(65) is "A" in either
  ASCII or Cyrillic, not Unicode. For the reverse of Char::Ecyrillic::chr, use Char::Cyrillic::ord.

=item Filename expansion (globbing)

  @glob = Char::Ecyrillic::glob($string);
  @glob = Char::Ecyrillic::glob_;
  ...
  The Char::Ecyrillic::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Ecyrillic::glob('"*e f*"');
  @spacies = Char::Ecyrillic::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Char::Ecyrillic::glob("'*${var}e f*'");
  @spacies = Char::Ecyrillic::glob(qq("*${var}e f*"));
