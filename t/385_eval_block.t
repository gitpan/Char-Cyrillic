...
# eval {...} has eval "..."
if (eval { eval Char::Cyrillic::escape " if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } " }) {
...
# eval {...} has eval qq{...}
if (eval { eval Char::Cyrillic::escape qq{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
...
# eval {...} has eval '...'
if (eval { eval Char::Cyrillic::escape ' if (qq{้ม} =~ /[แ]/i) { return 1 } else { return 0 } ' }) {
...
# eval {...} has eval q{...}
if (eval { eval Char::Cyrillic::escape q{ if ('้ม' =~ /[แ]/i) { return 1 } else { return 0 } } }) {
...
if (eval { eval Char::Cyrillic::escape $var }) {
...
if (eval { eval Char::Cyrillic::escape }) {
