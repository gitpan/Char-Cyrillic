...
=item Make character
  ...
  set. For example, Ecyrillic::chr(65) is "A" in either ASCII or Cyrillic, not Unicode,
  and Ecyrillic::chr(0x82a0) is a Cyrillic HIRAGANA LETTER A. For the reverse of
  Ecyrillic::chr, use Cyrillic::ord.
