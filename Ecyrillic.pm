...
This module is a run-time routines of the Cyrillic.pm.
Because the Cyrillic.pm automatically uses this module, you need not use directly.
...
=item Chop string
  ...
  character chopped. The Ecyrillic::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Ecyrillic::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Ecyrillic::fc function for case-insensitive comparisons via Cyrillic
  software.
...
=item Fold case string
  ...
  New to Cyrillic software, this function returns the full Unicode-like casefold of
...
=item Filename expansion (globbing)
  ...
  The Ecyrillic::glob function grandfathers the use of whitespace to separate multiple
