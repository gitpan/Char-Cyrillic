...
This module is a run-time routines of the Char::Cyrillic module.
Because the Char::Cyrillic module automatically uses this module, you need not use directly.
