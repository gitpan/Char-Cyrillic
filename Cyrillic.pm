...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Cyrillic software provides)

Cyrillic software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Cyrillic software provide)
