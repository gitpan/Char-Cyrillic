...
######################################################################
#
# Char::Cyrillic - Source code filter to Cyrillic script
#
...
sub Char::Cyrillic::escape_script {
    ...
    if (/^ use Char::Ecyrillic(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        $e_script .= sprintf("use Char::Ecyrillic %s;\n%s", $Char::Ecyrillic::VERSION, $use_re_eval); # require run-time routines version
...
Char::Cyrillic - Source code filter to escape Cyrillic

=head1 SYNOPSIS

  use Char::Cyrillic;
  use Char::Cyrillic version;         --- require version
