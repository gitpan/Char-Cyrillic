...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Ecyrillic::function_ord     = 'Char::Cyrillic::ord'     if /\A ord \z/oxms;
                    $Char::Ecyrillic::function_ord_    = 'Char::Cyrillic::ord_'    if /\A ord \z/oxms;
                    $Char::Ecyrillic::function_reverse = 'Char::Cyrillic::reverse' if /\A reverse \z/oxms;
                    $Char::Ecyrillic::function_getc    = 'Char::Cyrillic::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Cyrillic::escape();
...
=head1 Calling 'Char::Ecyrillic::ignorecase()' (Char::Cyrillic software provides)

Char::Cyrillic software applies calling 'Char::Ecyrillic::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Cyrillic software provides)

Char::Cyrillic software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Cyrillic software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Cyrillic software provides)

Char::Cyrillic software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Cyrillic software and
