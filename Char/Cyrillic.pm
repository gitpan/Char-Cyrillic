...
10% everything else. But this "text" means US-ASCII text, and popular Cyrillic
...
Perl3 or later can treat Cyrillic.

Perl is designed to make the easy jobs easy, without making the hard jobs
impossible. Char::Cyrillic software is Perl program designed to make the "easy jobs easy".
...
=item * Handles Raw Cyrillic, Doesn't use UTF8 flag like JPerl
...
Definitions in Char/Ecyrillic.pm.
  ...
  After                    Definition
  ---------------------------------------------------------------------------------------------------------------------------------------------------------
  ${Char::Ecyrillic::anchor}         qr{\G(?:[\x00-\xFF])*?}
  ...
  ${Char::Ecyrillic::not_space}      qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])}
...
It has already been achieved by Cyrillic designed for combining with
...
Contrasting is Encode module and describing "use Char::Cyrillic;" on this software,
