...
This module is a run-time routines of the Char/Cyrillic.pm.
Because the Char/Cyrillic.pm automatically uses this module, you need not use directly.
...
=item Transliteration
  ...
  This function scans a Cyrillic string character by character and replaces all
...
=item Chop string
  ...
  character chopped. The Char::Ecyrillic::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Ecyrillic::index except that it returns the byte
...
=item Lower case string
  ...
  This function returns a lowercased version of Cyrillic $string (or $_, if
  $string is omitted). This is the internal function implementing the \L escape
  in double-quoted strings.

  You can use the Char::Ecyrillic::fc function for case-insensitive comparisons via Char::Cyrillic
  software.
...
=item Lower case first character of string
  ...
  This function returns a version of Cyrillic $string with the first character
...
=item Upper case string
  ...
  This function returns an uppercased version of Cyrillic $string (or $_, if
...
=item Fold case string
  ...
  New to Char::Cyrillic software, this function returns the full Unicode-like casefold of
  Cyrillic $string (or $_, if omitted). This is the internal function implementing
...
=item Filename expansion (globbing)
  ...
  The Char::Ecyrillic::glob function grandfathers the use of whitespace to separate multiple
