...
Let's start with a bit of history: jperl 4.019+1.3 introduced Cyrillic support.
...
In this country, Cyrillic is widely used on mainframe I/O, the personal computer,
and the cellular phone. This software treats Cyrillic directly, but doesn't treat
