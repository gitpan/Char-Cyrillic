...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # /i modifier
        elsif ($ignorecase and (Ecyrillic::uc($char[$i]) ne Ecyrillic::lc($char[$i]))) {
...
=item * Only Cyrillic.pm and Ecyrillic.pm, other modules are unnecessary
...
functions.
  ...
  ---------------------------------
  lc          Ecyrillic::lc
  lcfirst     Ecyrillic::lcfirst
  uc          Ecyrillic::uc
  ucfirst     Ecyrillic::ucfirst
  chr         Ecyrillic::chr
  glob        Ecyrillic::glob
  ---------------------------------
...
Cyrillic.pm remove 'bytes::' at head of function name.
...
=head1 Perl5.6 Emulation on perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Ecyrillic.pm
  --------------------------------------------------------------------
  binmode(...);   Ecyrillic::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Ecyrillic::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Cyrillic software emulate perl5.6's binmode function.
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  open(FH, "<:crlf:encoding(Cyrillic)", $path) or die "can't open $path: $!";
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Ecyrillic.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Ecyrillic.pm provides bytes::*
