...
my $color  = Char::Cyrillic::substr $s, 4, 5;   # black
my $middle = Char::Cyrillic::substr $s, 4, -11; # black cat climbed the
my $end    = Char::Cyrillic::substr $s, 14;     # climebed the green tree
my $tail   = Char::Cyrillic::substr $s, -4;     # tree
my $z      = Char::Cyrillic::substr $s, -4, 2;  # tr
